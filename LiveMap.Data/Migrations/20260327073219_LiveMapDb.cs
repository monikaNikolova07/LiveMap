...
{
    /// <inheritdoc />
    public partial class LiveMapDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFollowings", x => new { x.UserId, x.FolowingId });
                    table.ForeignKey(
                        name: "FK_UserFollowings_AspNetUsers_FolowingId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FolderStructures", x => new { x.FolderId, x.SubfolderId });
                    table.ForeignKey(
                        name: "FK_FolderStructures_Folders_FolderId",
                        column: x => x.FolderId,
                        principalTable: "Folders",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FolderStructures_Folders_SubfolderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FolderStructures_SubfolderId",
                table: "FolderStructures",
                column: "SubfolderId");
